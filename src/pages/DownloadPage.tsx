...
const copy = {
  en: {
    ...
    cards: {
      ...
      biomarkerDesc: "Mann–Whitney U + BH-FDR biomarker output with a custom effect score and adjusted p-values.",
    ...
    helper: {
      ...
      biomarkerNote: "Exports the same marker statistics with public field names.",
  ...
  zh: {
    ...
    cards: {
      ...
      biomarkerDesc: "导出 Mann–Whitney U + BH-FDR 标志物结果，使用自定义效应分数并提供校正 p 值。",
    ...
    helper: {
      ...
      biomarkerNote: "导出同一组 marker 统计量，并使用公开字段名称。",
